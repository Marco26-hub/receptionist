...
export function VoiceAdmin({ initialData, categories }: Props) {
  ...
  async function runTest() {
    ...
    try {
      ...
      setNotice(result.provider === "template" ? "Fallback visibile: prova generata dal modello locale perché OpenAI/OpenRouter non è collegato." : `Prova completata con ${result.provider === "openrouter" ? "OpenRouter" : "OpenAI"}.`);
