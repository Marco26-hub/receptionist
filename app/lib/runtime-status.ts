...
export function getRuntimeServiceStatus(input: {
  ...
  return [
    ...
    { id: "whatsapp", label: "WhatsApp", state: whatsapp && !whatsappStatus.lastError ? "active" : "blocked", detail: whatsappStatus.lastError ? `Errore visibile: ${whatsappStatus.lastError}` : whatsapp ? "Meta collegato per questa azienda" : "Invio reale bloccato: Meta non collegato", href: "/admin/impostazioni" },
